...
export default React.createClass({
   render: function () {
      ...
      var _options = Object.keys(metaOptions).map(key=>{
         ...
         var component = <Input type="text" required="" value={meta.json[key]} updateValue={(v)=>patch({json: {...meta.json, [key]: v}})}/>;
      ...
      return (
         <form className="ui form">
            ...
            <div className="field">
               ...
               <Edits.Input lines={3} type="text" required="" value={meta.description} updateValue={(v)=>patch({description: v})}/>
            </div>
            {_options}
         </form>
      );
